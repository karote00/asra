  ...
  const steps = [
    ...
    },
    {
      ...
      conditions: [
        ...
        'Insert accepts one or more items through one strict validated batch descriptor, App-generated canonical ids, supported primitive/style fields, finite workspace bounds, and semantic roles without artificial item, subpath, per-path point, or composition point-count ceilings; an empty composition fails before mutation.',
    ...
    links: [
      {
        ...
        href: './completed/ai-conversational-drawing-plan.md'
      },
      {
