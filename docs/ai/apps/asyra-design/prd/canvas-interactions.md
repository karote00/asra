...
4. Path editing mode allows vector point-centric workflows.
5. Viewport supports zoom (modifier wheel), pan (plain wheel), zoom-fit shortcut.
6. Undo/redo reflects intended interaction unit boundaries.
