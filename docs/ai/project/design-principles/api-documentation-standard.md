...
This document defines the standard format for all API reference documentation stored in `docs/ai/project/apis/frontend/` and `docs/ai/project/apis/backend/`. Following this standard ensures that API documentation is clear, consistent, and provides the necessary level of detail for developers.
