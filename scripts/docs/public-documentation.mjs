...
const serializeLlms = ({ contentIndex }) => {
  const lines = [
    ...
    '',
    'Install @asyra/core for package-first composition, use create-asyra-design-app for the ready-to-use reference product, and use Start or Build guides for Framework composition.',
