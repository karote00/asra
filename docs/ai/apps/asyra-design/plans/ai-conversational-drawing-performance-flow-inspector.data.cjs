  ...
  const steps = [
    ...
    },
    {
      ...
      conditions: [
        ...
        'The 250-millisecond cadence is armed before the immediate first CPU sample, every sample has a 200-millisecond hard timeout, and guard SIGINT, SIGTERM, SIGHUP, exceptional exit, sampling failure, or benchmark failure terminates only the tracked process group.',
