  ...
  const steps = [
    ...
    },
    {
      ...
      conditions: [
        ...
        'Actor A and Actor B use independently launched Chromium process groups and their contexts are created first; Actor A completes navigation and reaches collaboration ready before Actor B navigation, Actor B then reaches collaboration ready before the guard-ready heartbeat, and every staged harness bootstrap phase stays outside product timing.',
