...
*   **Logical Grouping:** Store files in their respective logical directories within `docs/ai/project/` (e.g., `epics/`, `features/`, `golden-paths/`, `frontend-apis/`).
...
*   **Internal Links:** Use relative Markdown links to refer to other documents within the `docs/ai/project/` directory (e.g., `[Related Epic](../epics/some-epic.md)`).
