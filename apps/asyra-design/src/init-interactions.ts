...
export const initInteractions = () => {
  ...
  core.registerInteraction(InputSystemEvents.INPUT_DRAG_UPDATE, (snapshot) =>
  ...
  core.registerInteraction(InputSystemEvents.INPUT_SHORTCUT_ZOOM_PRESET, () =>
    decideZoomFitBehavior()
  )

  core.registerInteraction(InputSystemEvents.INPUT_WHEEL_SCROLL, (snapshot) =>
