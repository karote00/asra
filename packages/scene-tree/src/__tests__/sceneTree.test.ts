...
describe('SceneTree', () => {
  ...
  beforeEach(() => {
    ...
    vi.mocked(utils.createElement).mockImplementation((data: any) => ({
  ...
  it('should add an element to the map', () => {
    const element = { get: vi.fn(() => 'el-add') } as unknown as ElementInstanceTypes;
    sceneTree.addToMap(element);
    expect(sceneTree.getAllElements().has('el-add')).toBe(true);
  });

  it('should remove an element from the map', () => {
    const element = { get: vi.fn(() => 'el-remove') } as unknown as ElementInstanceTypes;
    sceneTree.addToMap(element);
  ...
  it('should get an element by ID', () => {
    const element = { get: vi.fn(() => 'el-get') } as unknown as ElementInstanceTypes;
    sceneTree.addToMap(element);
  ...
  it('should add a change for adding an element', () => {
    ...
    const element = { save: vi.fn(() => elementData), get: vi.fn(() => 'el-change') } as unknown as ElementInstanceTypes;
  ...
  it('should add a change for removing an element', () => {
    ...
    const element = { save: vi.fn(() => elementData), get: vi.fn(() => 'el-change-remove') } as unknown as ElementInstanceTypes;
  ...
  it('should add an element to the deleted map', () => {
    const element = { get: vi.fn(() => 'el-deleted') } as unknown as ElementInstanceTypes;
  ...
  it('should remove an element from the deleted map', () => {
    const element = { get: vi.fn(() => 'el-deleted-remove') } as unknown as ElementInstanceTypes;
    sceneTree.addToDeleteMap(element);
  ...
  it('should restore an element from the deleted map and add a change', () => {
    ...
    const element = { save: vi.fn(() => elementData), get: vi.fn(() => 'el-restore') } as unknown as ElementInstanceTypes;
    sceneTree.addToDeleteMap(element);
  ...
  it('should call addNewElement on the current workspace', () => {
    ...
    const element = { get: vi.fn(() => 'new-el') } as unknown as ElementInstanceTypes;
    sceneTree.addNewElement(element);
    expect(mockWorkspaceInstance.addNewElement).toHaveBeenCalledWith(element, undefined, -1);
  });
  ...
  it('should load data correctly', () => {
    ...
    expect(utils.createWorkspace).toHaveBeenCalledWith(dataToLoad.elements['ws-load']);
    expect(utils.createElement).toHaveBeenCalledWith(dataToLoad.elements['el-load-1']);
  });

  it('should save data correctly', () => {
    sceneTree.init(); // Ensure initial workspace
    const elementData = { id: 'el-save', type: EntityTypes.RECTANGLE };
    const element = { save: vi.fn(() => elementData), get: vi.fn(() => 'el-save') } as unknown as ElementInstanceTypes;
    sceneTree.addToMap(element);
    ...
    expect(savedData.elements['workspace-1']).toEqual(mockWorkspaceInstance.save());
