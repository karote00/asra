...
3. **Define Templates**: Use appropriate `docs/ai/project/templates/` formats
...
- **Template Usage**: Uses project templates from `docs/ai/project/templates/`
...
Located in: `docs/ai/project/templates/api-doc-template.md`

### User Guide Template

Located in: `docs/ai/project/templates/user-guide-template.md`

### Architecture Doc Template

Located in: `docs/ai/project/templates/architecture-doc-template.md`
...
- `docs/ai/project/templates/` for consistent formatting
