...
1.  **Pre-Implementation Documentation:**
    ...
    - **Golden Path:** Detailed user interaction flow (`docs/ai/project/golden-paths/`).
    - **BDD Features:** Behavior-Driven Development feature files (`docs/ai/project/bdd-features/`).
    - **Task Breakdowns:** Detailed sub-tasks with objectives, file changes, and dependencies (`docs/ai/project/task-breakdowns/`).
