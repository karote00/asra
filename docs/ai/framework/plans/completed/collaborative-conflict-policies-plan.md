...
`network-collaboration-transport-plan.md` product contract. This supersession
is the final closeout decision for this retained historical plan.

It is not an active framework plan and authorizes no framework implementation.
