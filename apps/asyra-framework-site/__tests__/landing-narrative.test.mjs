...
test('Galaxy follows the approved irregular reference and motion contract', () => {
  ...
  assert.match(galaxy, /type ReferenceFlareTier/)
  assert.match(galaxy, /flareTierMetrics/)
  assert.match(galaxy, /diamondSubpath/)
  assert.match(galaxy, /microBurstSubpath/)
  assert.match(galaxy, /galaxy-map__flare-bloom/)
  assert.match(galaxy, /galaxy-map__flare-corona/)
  assert.match(galaxy, /galaxy-map__flare-primary--vertical/)
  assert.match(galaxy, /galaxy-map__flare-primary--horizontal/)
  assert.match(galaxy, /galaxy-map__flare-spectral-needles/)
  assert.match(galaxy, /galaxy-map__flare-microburst/)
