...
- **Golden Path**: Step-by-step user interaction flow (`docs/ai/project/golden-paths/`)
- **BDD Features**: Behavior-driven feature files (`docs/ai/project/bdd-features/`)
- **Task Breakdowns**: Implementation sub-tasks (`docs/ai/project/task-breakdowns/`)
...
- Update `docs/ai/project/ASSUMPTIONS.md` with new patterns
