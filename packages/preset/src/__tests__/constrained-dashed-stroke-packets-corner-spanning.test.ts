...
describe('constrained dashed stroke packets: corner-spanning behavior', () => {
  ...
  it('should run: high-curvature inside dashed packets stay visible as domain-plan selected-side product until arrangement clipping is exact', () => {
    ...
    const packets = buildConstrainedDashedStrokeResolvedPackets(
      'reference:high-curvature-cubic-loop-inside-dashed',
      points,
      true,
      [
        createDefaultStroke({
