...
1. **Create PRD**: Write Product Requirements Document in `docs/ai/project/prd/`
2. **Write BDD Scenarios**: Create behavior files in `docs/ai/project/features/`
3. **Plan Task Breakdown**: Document implementation steps in `docs/ai/project/task-breakdowns/`
4. **Design Golden Path**: Create user journey in `docs/ai/project/golden-paths/`
