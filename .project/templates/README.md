...
- **Usage**: When creating new epics in `.project/epics/`
...
- **Usage**: Referenced in `.project/ASSUMPTIONS.md`
...
4. **Reference correctly**: Always reference templates with full path (e.g., `.project/templates/changelog-template.md`)
