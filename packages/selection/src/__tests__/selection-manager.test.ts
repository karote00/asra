...
describe('SelectionManager', () => {
  ...
  it('should register and retrieve selections correctly', () => {
    manager.register(SELECTION_TYPES.ELEMENT, mockBaseSelection as unknown as BaseSelection);
  ...
  it('should return undefined for an unregistered selection type', () => {
    const selection = manager.get(SELECTION_TYPES.AREA);
  ...
  it('should call clear() on all registered selections when clearAllSelections is called', () => {
    ...
    manager.register(SELECTION_TYPES.ELEMENT, mockSelection1 as unknown as BaseSelection);
    manager.register(SELECTION_TYPES.AREA, mockSelection2 as unknown as BaseSelection);
