...
const dragPerformanceCases = createStrokeDragRenderPerformanceUXGateCases({
  suiteLabel: 'open center dashed',
  strokeCases: STROKE_DRAG_PERFORMANCE_CASE_GROUPS.openCenterDashed
})

test.describe('stroke drag render performance UX gate: open center dashed', () => {
